...
class Formgrab
{
	...
	*/
	...
	public function form() {
		...
		if( ee()->TMPL->fetch_param('required') ) {
			$hidden_fields['formgrab_required'] = ee()->TMPL->fetch_param('required');
		}


		$title = ee()->TMPL->fetch_param('title');
		if( $title !== FALSE ) {
			$hidden_fields['formgrab_title'] = $title;
		}
