...
--
-- Truncate table before insert `exp_actions`
--

TRUNCATE TABLE `exp_actions`;
--
...
--
-- Truncate table before insert `exp_captcha`
--

TRUNCATE TABLE `exp_captcha`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_categories`
--
...
--
-- Truncate table before insert `exp_category_fields`
--

TRUNCATE TABLE `exp_category_fields`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_category_field_data`
--
...
--
-- Truncate table before insert `exp_category_groups`
--
...
--
-- Truncate table before insert `exp_category_posts`
--
...
--
-- Truncate table before insert `exp_channels`
--

TRUNCATE TABLE `exp_channels`;
--
...
(2, 1, 'blog', 'Blog', '{path=\'blog/entry\'}', NULL, 'en', 8, 8, 0, 1515540988, 0, '1', 'open', NULL, NULL, 'y', 'y', NULL, 'all', 'n', 'y', 'n', 'n', NULL, NULL, 'y', 'n', 'n', 5000, 0, 'y', 'xhtml', 'safe', 'n', 'y', 'n', 'n', NULL, 0, NULL, NULL, 'n', 10, NULL, 'Title', NULL, 0, NULL),
...
(4, 1, 'communities', 'Communities', '//', '', 'en', 4, 4, 0, 1538001480, 0, '', 'open', NULL, '', 'y', 'y', NULL, 'all', 'n', 'y', 'n', 'n', '', '', 'y', 'n', 'n', 5000, 0, 'y', 'xhtml', 'safe', 'n', 'y', 'n', 'n', '', 0, '', '', 'n', 10, '', 'Community Name', '', 0, NULL);
...
--
-- Truncate table before insert `exp_channels_channel_fields`
--

TRUNCATE TABLE `exp_channels_channel_fields`;
--
...
--
-- Truncate table before insert `exp_channels_channel_field_groups`
--

TRUNCATE TABLE `exp_channels_channel_field_groups`;
--
...
--
-- Truncate table before insert `exp_channels_statuses`
--

TRUNCATE TABLE `exp_channels_statuses`;
--
...
--
-- Truncate table before insert `exp_channel_data`
--

TRUNCATE TABLE `exp_channel_data`;
--
...
--
-- Truncate table before insert `exp_channel_data_field_1`
--

TRUNCATE TABLE `exp_channel_data_field_1`;
--
...
--
-- Truncate table before insert `exp_channel_data_field_2`
--

TRUNCATE TABLE `exp_channel_data_field_2`;
--
...
--
-- Truncate table before insert `exp_channel_data_field_3`
--

TRUNCATE TABLE `exp_channel_data_field_3`;
--
...
--
-- Truncate table before insert `exp_channel_data_field_4`
--

TRUNCATE TABLE `exp_channel_data_field_4`;
--
...
--
-- Truncate table before insert `exp_channel_data_field_5`
--

TRUNCATE TABLE `exp_channel_data_field_5`;
--
...
--
-- Truncate table before insert `exp_channel_data_field_6`
--

TRUNCATE TABLE `exp_channel_data_field_6`;
--
...
--
-- Truncate table before insert `exp_channel_data_field_7`
--

TRUNCATE TABLE `exp_channel_data_field_7`;
--
...
--
-- Truncate table before insert `exp_channel_data_field_8`
--

TRUNCATE TABLE `exp_channel_data_field_8`;
--
...
--
-- Truncate table before insert `exp_channel_data_field_9`
--

TRUNCATE TABLE `exp_channel_data_field_9`;
--
...
--
-- Truncate table before insert `exp_channel_data_field_10`
--

TRUNCATE TABLE `exp_channel_data_field_10`;
--
...
--
-- Truncate table before insert `exp_channel_data_field_11`
--

TRUNCATE TABLE `exp_channel_data_field_11`;
--
...
--
-- Truncate table before insert `exp_channel_data_field_12`
--

TRUNCATE TABLE `exp_channel_data_field_12`;
--
...
(4, 16, '<p>SOmething about LA Ventana</p>', 'xhtml');
...
--
-- Truncate table before insert `exp_channel_data_field_13`
--

TRUNCATE TABLE `exp_channel_data_field_13`;
--
...
--
-- Truncate table before insert `exp_channel_entries_autosave`
--

TRUNCATE TABLE `exp_channel_entries_autosave`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_channel_fields`
--

TRUNCATE TABLE `exp_channel_fields`;
--
...
--
-- Truncate table before insert `exp_channel_field_groups_fields`
--

TRUNCATE TABLE `exp_channel_field_groups_fields`;
--
...
--
-- Truncate table before insert `exp_channel_form_settings`
--

TRUNCATE TABLE `exp_channel_form_settings`;
--
...
--
-- Truncate table before insert `exp_channel_grid_field_1`
--

TRUNCATE TABLE `exp_channel_grid_field_1`;
--
...
--
-- Truncate table before insert `exp_channel_grid_field_2`
--

TRUNCATE TABLE `exp_channel_grid_field_2`;
--
...
--
-- Truncate table before insert `exp_channel_grid_field_4`
--

TRUNCATE TABLE `exp_channel_grid_field_4`;
--
...
--
-- Truncate table before insert `exp_channel_grid_field_5`
--

TRUNCATE TABLE `exp_channel_grid_field_5`;
--
...
--
-- Truncate table before insert `exp_channel_grid_field_7`
--

TRUNCATE TABLE `exp_channel_grid_field_7`;
--
...
--
-- Truncate table before insert `exp_channel_member_groups`
--

TRUNCATE TABLE `exp_channel_member_groups`;
--
...
--
-- Truncate table before insert `exp_channel_titles`
--

TRUNCATE TABLE `exp_channel_titles`;
--
...
(16, 1, 4, 2, NULL, '187.131.18.39', 'La Ventana', 'la-ventana', 'open', 1, 'n', 0, 0, 0, 0, 'y', 'n', 1538001480, '2018', '09', '26', 0, 0, 1538001542, NULL, 0);
...
--
-- Truncate table before insert `exp_comments`
--

TRUNCATE TABLE `exp_comments`;
--
...
--
-- Truncate table before insert `exp_comment_subscriptions`
--

TRUNCATE TABLE `exp_comment_subscriptions`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_consents`
--

TRUNCATE TABLE `exp_consents`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_consent_audit_log`
--

TRUNCATE TABLE `exp_consent_audit_log`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_consent_requests`
--

TRUNCATE TABLE `exp_consent_requests`;
--
...
--
-- Truncate table before insert `exp_consent_request_versions`
--

TRUNCATE TABLE `exp_consent_request_versions`;
--
...
--
-- Truncate table before insert `exp_content_types`
--

TRUNCATE TABLE `exp_content_types`;
--
...
--
-- Truncate table before insert `exp_cp_log`
--

TRUNCATE TABLE `exp_cp_log`;
--
...
--
-- Truncate table before insert `exp_developer_log`
--

TRUNCATE TABLE `exp_developer_log`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_email_cache`
--

TRUNCATE TABLE `exp_email_cache`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_email_cache_mg`
--

TRUNCATE TABLE `exp_email_cache_mg`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_email_cache_ml`
--

TRUNCATE TABLE `exp_email_cache_ml`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_email_console_cache`
--

TRUNCATE TABLE `exp_email_console_cache`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_entry_versioning`
--

TRUNCATE TABLE `exp_entry_versioning`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_extensions`
--

TRUNCATE TABLE `exp_extensions`;
--
...
--
-- Truncate table before insert `exp_fieldtypes`
--

TRUNCATE TABLE `exp_fieldtypes`;
--
...
--
-- Truncate table before insert `exp_field_groups`
--
...
--
-- Truncate table before insert `exp_files`
--

TRUNCATE TABLE `exp_files`;
--
...
--
-- Truncate table before insert `exp_file_categories`
--

TRUNCATE TABLE `exp_file_categories`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_file_dimensions`
--

TRUNCATE TABLE `exp_file_dimensions`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_file_watermarks`
--

TRUNCATE TABLE `exp_file_watermarks`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_fluid_field_data`
--

TRUNCATE TABLE `exp_fluid_field_data`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_global_variables`
--

TRUNCATE TABLE `exp_global_variables`;
--
...
--
-- Truncate table before insert `exp_grid_columns`
--

TRUNCATE TABLE `exp_grid_columns`;
--
...
--
-- Truncate table before insert `exp_html_buttons`
--
...
--
-- Truncate table before insert `exp_layout_publish`
--

TRUNCATE TABLE `exp_layout_publish`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_layout_publish_member_groups`
--

TRUNCATE TABLE `exp_layout_publish_member_groups`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_members`
--

TRUNCATE TABLE `exp_members`;
--
...
--
-- Truncate table before insert `exp_member_bulletin_board`
--

TRUNCATE TABLE `exp_member_bulletin_board`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_member_data`
--

TRUNCATE TABLE `exp_member_data`;
--
...
--
-- Truncate table before insert `exp_member_fields`
--

TRUNCATE TABLE `exp_member_fields`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_member_groups`
--

TRUNCATE TABLE `exp_member_groups`;
--
...
--
-- Truncate table before insert `exp_member_news_views`
--

TRUNCATE TABLE `exp_member_news_views`;
--
...
--
-- Truncate table before insert `exp_member_search`
--

TRUNCATE TABLE `exp_member_search`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_menu_items`
--

TRUNCATE TABLE `exp_menu_items`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_menu_sets`
--

TRUNCATE TABLE `exp_menu_sets`;
--
...
--
-- Truncate table before insert `exp_message_attachments`
--

TRUNCATE TABLE `exp_message_attachments`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_message_copies`
--

TRUNCATE TABLE `exp_message_copies`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_message_data`
--

TRUNCATE TABLE `exp_message_data`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_message_folders`
--

TRUNCATE TABLE `exp_message_folders`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_message_listed`
--

TRUNCATE TABLE `exp_message_listed`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_modules`
--

TRUNCATE TABLE `exp_modules`;
--
...
--
-- Truncate table before insert `exp_module_member_groups`
--

TRUNCATE TABLE `exp_module_member_groups`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_online_users`
--

TRUNCATE TABLE `exp_online_users`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_password_lockout`
--

TRUNCATE TABLE `exp_password_lockout`;
--
...
--
-- Truncate table before insert `exp_plugins`
--

TRUNCATE TABLE `exp_plugins`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_relationships`
--

TRUNCATE TABLE `exp_relationships`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_remember_me`
--

TRUNCATE TABLE `exp_remember_me`;
--
...
--
-- Truncate table before insert `exp_reset_password`
--

TRUNCATE TABLE `exp_reset_password`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_revision_tracker`
--

TRUNCATE TABLE `exp_revision_tracker`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_rte_tools`
--

TRUNCATE TABLE `exp_rte_tools`;
--
...
--
-- Truncate table before insert `exp_rte_toolsets`
--

TRUNCATE TABLE `exp_rte_toolsets`;
--
...
--
-- Truncate table before insert `exp_search`
--

TRUNCATE TABLE `exp_search`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_search_log`
--

TRUNCATE TABLE `exp_search_log`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_security_hashes`
--

TRUNCATE TABLE `exp_security_hashes`;
--
...
--
-- Truncate table before insert `exp_sessions`
--

TRUNCATE TABLE `exp_sessions`;
--
...
('fe6051926459f4c21717be24a514c87fc9062ba3', 1, 1, '187.131.18.39', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36', NULL, '65c4b94ac694e3bd69af7d7689136074', 1538013259, 0, 1538013259, 'n');
...
--
-- Truncate table before insert `exp_sites`
--

TRUNCATE TABLE `exp_sites`;
--
...
(1, 'Diamante Realtors', 'baja_mls', NULL, '', '', '', '', 'YToyOntzOjc6ImVtYWlsZWQiO2E6MDp7fXM6MzY6Ii9ob21lL2RpYW1hbnRlL3B1YmxpY19odG1sL2luZGV4LnBocCI7czozMjoiN2RkMGIzZmY1MDNlYTllYjE1NTMzMzVjNmY4MzVjODciO30=', 'YToxOntpOjE7YTozOntzOjQ6InVyaXMiO2E6MDp7fXM6OToidGVtcGxhdGVzIjthOjA6e31zOjM6InVybCI7czoxMToie2Jhc2VfdXJsfS8iO319');
...
--
-- Truncate table before insert `exp_snippets`
--

TRUNCATE TABLE `exp_snippets`;
--
...
--
-- Truncate table before insert `exp_specialty_templates`
--

TRUNCATE TABLE `exp_specialty_templates`;
--
...
--
-- Truncate table before insert `exp_stats`
--

TRUNCATE TABLE `exp_stats`;
--
...
(1, 1, 2, 2, 'cguemez', 13, 0, 0, 15, 1538001480, 0, 1515541007, 0, 0, 0, 1538585641);
...
--
-- Truncate table before insert `exp_statuses`
--

TRUNCATE TABLE `exp_statuses`;
--
...
--
-- Truncate table before insert `exp_status_no_access`
--

TRUNCATE TABLE `exp_status_no_access`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_templates`
--
...
INSERT INTO `exp_templates` (`template_id`, `site_id`, `group_id`, `template_name`, `template_type`, `template_data`, `template_notes`, `edit_date`, `last_author_id`, `cache`, `refresh`, `no_auth_bounce`, `enable_http_auth`, `allow_php`, `php_parse_location`, `hits`, `protect_javascript`) VALUES
(28, 1, 11, 'index', 'webpage', '{layout=\'layouts/_main-layout\'}\r\n\r\n{layout:set name=\"styles\"}\r\n    <style>\r\n        .search-card .card-content {\r\n            padding-bottom:0;\r\n        }\r\n        .search-car .card-content row {\r\n            margin-bottom:0;\r\n        }\r\n        main {\r\n            margin-top: 150px;\r\n        }\r\n    </style>\r\n{/layout:set}\r\n\r\n<?php\r\n    error_reporting( E_ALL ); //debug\r\n    require_once($_SERVER[\'DOCUMENT_ROOT\'] . \"/flexmls/flexmlsAPI.php\");\r\n    require_once($_SERVER[\'DOCUMENT_ROOT\'] . \"/lang/lang.php\");\r\n    $protocol = strtolower(substr($_SERVER[\"SERVER_PROTOCOL\"],0,5))==\'https://\'?\'https://\':\'http://\';\r\n    $hostName = $_SERVER[\'HTTP_HOST\'];\r\n    $base_url = $protocol.$hostName;\r\n    $api = new flexmlsAPI(\"cab_westerlund_key_1\", \"5lCZrVg8d4uYSviaNIN4t\");\r\n    $api->SetApplicationName(\"Diamante-MLS-Search/1.0\");\r\n    $api->SetDeveloperMode(false);\r\n    $auth = $api->Authenticate();\r\n    if ($auth === false) api_error_thrown($api);\r\n\r\n    $portal = isset($_GET[\'portal\']) ? trim($_GET[\'portal\']) : 0;\r\n    $mls_number = isset($_GET[\'mls_number\']) ? trim($_GET[\'mls_number\']) : \'\';\r\n    //$city = isset($_GET[\'city\']) ? trim($_GET[\'city\']) : \'\';\r\n    $city = \"{segment_2}\" != \"\" ? \"{segment_2}\" : \"all\";\r\n    //$property_type = isset($_GET[\'property_type\']) ? trim($_GET[\'property_type\']) : \'\';\r\n    $property_type  = \"{segment_3}\" != \"\" ? \"{segment_3}\" : \"all\";\r\n    //$list_price = isset($_GET[\'list_price\']) ? trim($_GET[\'list_price\']) : \'\';\r\n    $list_price = \"{segment_4}\" != \"\" ? \"{segment_4}\" : \"all\";\r\n    $development = isset($_GET[\'development\']) ? trim($_GET[\'development\']) : \'\';\r\n    $language = isset($_GET[\'lang\']) ? trim($_GET[\'lang\']) : \'en\';\r\n    //$page = isset($_GET[\'page\']) ? trim($_GET[\'page\']) : 1;\r\n    $page = is_numeric(\"{segment_5}\") ? \"{segment_5}\"  : 1;\r\n    $featured = isset($_GET[\'featured\']) ? $_GET[\'featured\'] : 0;\r\n\r\n    $exchange_rate = 1;\r\n    $parameters = null;\r\n    $listings = null;\r\n    \r\n    if($language == \'es\') {\r\n        $xml = simplexml_load_file(\"http://www.ecb.int/stats/eurofxref/eurofxref-daily.xml\")->Cube[0]->Cube[0];\r\n        $usd = 0;\r\n        $mxn = 0;\r\n        foreach ($xml->Cube as $item) {\r\n            if((string)$item[\'currency\'] === \'USD\')\r\n                $usd = (real)$item[\'rate\'];\r\n                \r\n            if((string)$item[\'currency\'] === \'MXN\')\r\n                $mxn = (real)$item[\'rate\'];\r\n        }\r\n\r\n        $exchange_rate = $mxn/$usd;\r\n    }\r\n\r\n    switch ($city) {\r\n        case \"la-paz\" : $cityQuery = \"City Eq \'La Paz\'\"; break;\r\n        case \"la-ventana\" : $cityQuery = \"SubdivisionName Eq \'La Ventana\' Or SubdivisionName Eq \'El Sargento\'\"; break;\r\n        case \"cabo-san-lucas\" : $cityQuery = \"City Eq \'Cabo San Lucas\'\"; break;\r\n        case \"cabo-corridor\" : $cityQuery = \"City Eq \'Cabo Corridor\'\"; break;\r\n        case \"san-jose-del-cabo\" : $cityQuery = \"City Eq \'San Jose del Cabo\'\"; break;\r\n        case \"san-jose-corridor\" : $cityQuery = \"City Eq \'San Jose Corridor\'\"; break;\r\n        case \"east-cape\" : $cityQuery = \"City Eq \'East Cape\' Or City Eq \'Los Barriles\'\"; break;\r\n        case \"pacific-side\" : $cityQuery = \"City Eq \'Pacific Or City Eq \'Pacific Side\' Or City Eq \'Todos Santos\'\"; break;\r\n        default : $cityQuery = \"\";\r\n    }\r\n\r\n    switch ($property_type) {\r\n        case \"condos\" : $propertyQuery = \"A\"; break;\r\n        case \"houses\" : $propertyQuery = \"B\"; break;\r\n        case \"townhouses\" : $propertyQuery = \"C\"; break;\r\n        case \"land\" : $propertyQuery = \"E\"; break;\r\n        case \"commercial\" : $propertyQuery = \"F\"; break;\r\n        case \"business\" : $propertyQuery = \"G\"; break;\r\n        case \"multifamily\" : $propertyQuery = \"I\"; break;\r\n        default : $propertyQuery = \"\";\r\n    }\r\n\r\n    switch ($list_price) {\r\n        case \"0\" : $listQuery = \"Le 200000.0\"; break;\r\n        case \"200K\" : $listQuery = \"Ge 200000.0 And ListPrice Le 500000.0\"; break;\r\n        case \"500K\" : $listQuery = \"Ge 500000.0 And ListPrice Le 1000000.0\"; break;\r\n        case \"1M\" : $listQuery = \"Ge 1000000.0\"; break;\r\n        default : $listQuery = \"\";\r\n    }\r\n\r\n\r\n    if($mls_number != \'\') {\r\n        $parameters = array(\"_filter\" => \"ListingId Eq \'$mls_number\'\", \"_expand\" => \'PrimaryPhoto\', \"_limit\" => \"1\", \"_pagination\" => true);\r\n        $listings = $api->GetListings($parameters);\r\n    }\r\n    else {\r\n        $filter = \'\';\r\n        $p_type = ($propertyQuery != \"\") ? \"PropertyType Eq \'$propertyQuery\'\": \"Not PropertyType Eq \'H\'\";\r\n        $filter .= ($filter != \'\') ? \" And $p_type\" : \"$p_type\" ;\r\n        $filter .= ($cityQuery != \'\') ? (($filter != \'\') ? \" And $cityQuery\" : \"$cityQuery\" ) : \'\';\r\n        $filter .= ($listQuery != \'\') ? (($filter != \'\') ? \" And ListPrice $listQuery\" : \"ListPrice $listQuery\" ) : \'\';\r\n        if ($development == \'Terrazas\' || $development == \'Torres Cantera\' || $development == \'Vista Coral\' || $development == \'Paseo del Malecon\' || $development == \'Puerto Ilusion\' || $development == \'Querencia\' || $development == \'Palmilla\') {\r\n            $filter .= ($filter != \'\') ? \" And StreetAdditionalInfo Eq \'$development*\'\" : \"StreetAdditionalInfo Eq \'$development*\'\";\r\n        }\r\n        else {\r\n            $filter .= ($development != \'\') ? (($filter != \'\') ? \" And SubdivisionName Eq \'$development\'\" : \"SubdivisionName Eq \'$development\'\" ) : \'\';\r\n        }\r\n        $filter = stripslashes($filter);\r\n\r\n        //echo $filter;\r\n\r\n        if($featured == 1) {\r\n            $parameters = array(\"_filter\" => $filter, \"_expand\" => \'PrimaryPhoto\', \"_limit\" => 24, \"_pagination\" => true, \"_page\" => $page, \"_orderby\" => \'ListPrice\');\r\n            $listings = $api->GetMyListings($parameters);\r\n        }\r\n        else {\r\n            $parameters = array(\"_filter\" => $filter, \"_expand\" => \'PrimaryPhoto\', \"_limit\" => 24, \"_pagination\" => true, \"_page\" => $page, \"_orderby\" => \'ListPrice\');\r\n            $listings = $api->GetListings($parameters);\r\n        }\r\n    }\r\n    $listings[count($listings)] = array(\"LastCount\" => $api->last_count, \"PageSize\" => $api->page_size, \"TotalPages\" => $api->total_pages, \"CurrentPage\" => $api->current_page);\r\n    //var_dump($listings[count($listings)-1]);\r\n    //echo json_encode($listings);\r\n?>\r\n\r\n<main>\r\n    <div class=\"container\">\r\n\r\n        <div class=\"card search-card\">\r\n            <div class=\"card-content\">\r\n                <div class=\"card-title\">\r\n                    MLS Search\r\n                </div>\r\n                <div class=\"row\">\r\n                    <form class=\"col s12\">\r\n                    <div class=\"row\">\r\n                        <div class=\"input-field col s12 m6 l3\">\r\n                            <input id=\"mls_number\" type=\"text\" class=\"validate\">\r\n                            <label for=\"mls_number\">MLS Number</label>\r\n                        </div>\r\n                        <div class=\"input-field col s12 m6 l3\">\r\n                            <select id=\"city\">\r\n                                <option value=\"all\"><?php echo $lang[$language][\'any\']; ?></option>\r\n                                <?php if($portal == 1) { ?>\r\n                                    <option value=\"la-ventana\" <?php echo $city == \"la-ventana\" ? \"selected\" : \"\"?>>La Ventana</option>\r\n                                <option value=\"la-paz\" <?php echo $city == \"la-paz\" ? \"selected\" : \"\"?>>La Paz</option>\r\n                                <option value=\"cabo-san-lucas\" <?php echo $city == \"cabo-san-lucas\" ? \"selected\" : \"\"?>>Cabo San Lucas</option>\r\n                                <option value=\"cabo-corridor\" <?php echo $city == \"cabo-corridor\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'cabo_corridor\']; ?></option>\r\n                                <option value=\"san-jose-del-cabo\" <?php echo $city == \"san-jose-del-cabo\" ? \"selected\" : \"\"?>>San Jose del Cabo</option>\r\n                                <option value=\"san-jose-corridor\" <?php echo $city == \"san-jose-corridor\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'san_jose_corridor\']; ?></option>\r\n                                <option value=\"east-cape\" <?php echo $city == \"east-cape\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'east_cape\']; ?></option>\r\n                                <option value=\"pacific-side\" <?php echo $city == \"pacific-side\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'pacific_side\']; ?></option>\r\n                                <?php } elseif($portal == 3 || $portal == 4 || $portal == 5) { ?>\r\n                                <option value=\"cabo-san-lucas\" <?php echo $city == \"cabo-san-lucas\" ? \"selected\" : \"\"?>>Cabo San Lucas</option>\r\n                                <option value=\"cabo-corridor\" <?php echo $city == \"cabo-corridor\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'cabo_corridor\']; ?></option>\r\n                                <option value=\"san-jose-del-cabo\" <?php echo $city == \"san-jose-del-cabo\" ? \"selected\" : \"\"?>>San Jose del Cabo</option>\r\n                                <option value=\"san-jose-corridor\" <?php echo $city == \"san-jose-corridor\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'san_jose_corridor\']; ?></option>\r\n                                <option value=\"east-cape\" <?php echo $city == \"east-cape\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'east_cape\']; ?></option>\r\n                                <option value=\"pacific-side\" <?php echo $city == \"pacific-side\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'pacific_side\']; ?></option>\r\n                                <option value=\"la-paz\" <?php echo $city == \"la-paz\" ? \"selected\" : \"\"?>>La Paz</option>\r\n                                <option value=\"la-ventana\" <?php echo $city == \"la-ventana\" ? \"selected\" : \"\"?>>La Ventana</option>\r\n                                <?php } else { ?>\r\n                                <option value=\"la-paz\" <?php echo $city == \"la-paz\" ? \"selected\" : \"\"?>>La Paz</option>\r\n                                <option value=\"la-ventana\" <?php echo $city == \"la-ventana\" ? \"selected\" : \"\"?>>La Ventana</option>\r\n                                <option value=\"cabo-san-lucas\" <?php echo $city == \"cabo-san-lucas\" ? \"selected\" : \"\"?>>Cabo San Lucas</option>\r\n                                <option value=\"cabo-corridor\" <?php echo $city == \"cabo-corridor\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'cabo_corridor\']; ?></option>\r\n                                <option value=\"san-jose-del-cabo\" <?php echo $city == \"san-jose-del-cabo\" ? \"selected\" : \"\"?>>San Jose del Cabo</option>\r\n                                <option value=\"san-jose-corridor\" <?php echo $city == \"san-jose-corridor\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'san_jose_corridor\']; ?></option>\r\n                                <option value=\"east-cape\" <?php echo $city == \"east-cape\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'east_cape\']; ?></option>\r\n                                <option value=\"pacific-side\" <?php echo $city == \"pacific-side\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'pacific_side\']; ?></option>\r\n                                <?php } ?>\r\n                            </select>\r\n                            <label>City</label>\r\n                        </div>\r\n                        <div class=\"input-field col s12 m6 l3\">\r\n                            <select id=\"property_type\">\r\n                                <option value=\"all\"><?php echo $lang[$language][\'any\']; ?></option>\r\n                                <option value=\"condos\" <?php echo $property_type == \"condos\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'condos\']; ?></option>\r\n                                <option value=\"houses\" <?php echo $property_type == \"houses\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'houses\']; ?></option>\r\n                                <option value=\"townhouses\" <?php echo $property_type == \"townhouses\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'townhouses\']; ?></option>\r\n                                <option value=\"land\" <?php echo $property_type == \"land\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'land\']; ?></option>\r\n                                <option value=\"commercial\" <?php echo $property_type == \"commercial\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'commercial\']; ?></option>\r\n                                <option value=\"business\" <?php echo $property_type == \"business\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'business\']; ?></option>\r\n                                <option value=\"multifamily\" <?php echo $property_type == \"multifamily\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'multifamily\']; ?></option>\r\n                            </select>\r\n                            <label>Property type</label>\r\n                        </div>\r\n                        <div class=\"input-field col s12 m6 l3\">\r\n                            <select id=\"list_price\">\r\n                                <option value=\"all\"><?php echo $lang[$language][\'any\']; ?></option>\r\n                                <option value=\"0\" <?php echo $list_price == \"0\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'under\']; ?> 200,000 USD</option>\r\n                                <option value=\"200K\" <?php echo $list_price == \"200K\" ? \"selected\" : \"\"?>>200,000 - 500,000 USD</option>\r\n                                <option value=\"500K\" <?php echo $list_price == \"500K\" ? \"selected\" : \"\"?>>500,000 - 1,000,000 USD</option>\r\n                                <option value=\"1M\" <?php echo $list_price == \"1M\" ? \"selected\" : \"\"?>><?php echo $lang[$language][\'over\']; ?> 1,000,000 USD</option>\r\n                            </select>\r\n                            <label>Price</label>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n\r\n            </div>\r\n            <div class=\"card-action right-align\">\r\n                <div class=\"left\">Total results: <?php echo $listings[sizeof($listings)-1][\"LastCount\"] ?></div>\r\n                <a id=\"searchBtn\" class=\"btn waves-effect waves-light\">Search\r\n                    <i class=\"material-icons right\">search</i>\r\n                </a>\r\n            </div>\r\n        </div>\r\n\r\n        <ul class=\"pagination center-align\">\r\n            <?php if ($page > 1) { ?>\r\n                <li class=\"waves-effect\"><a href=\"<?php echo $base_url.\"/listing\".\"/\".$city.\"/\".$property_type.\"/\".$list_price.\"/\".($page-1) ?>\"><i class=\"material-icons\">chevron_left</i></a></li>\r\n            <?php } ?>\r\n                \r\n            <?php \r\n                $total_pages = $listings[sizeof($listings)-1][\"TotalPages\"];\r\n                for($x = $page - 3; $x <= $page + 3; $x++) { \r\n                    if ($x > 0 && $x <= $total_pages) {?>\r\n                        <li class=\"waves-effect <?php echo $x == $page ? \'active indigo\' : \'\' ?>\"><a href=\"<?php echo $base_url.\"/listing\".\"/\".$city.\"/\".$property_type.\"/\".$list_price.\"/\".$x ?>\"><?php echo $x ?></a></li>\r\n                <?php } }\r\n            ?>\r\n\r\n            <?php if ($page < $total_pages) { ?>\r\n                <li class=\"waves-effect\"><a href=\"<?php echo $base_url.\"/listing\".\"/\".$city.\"/\".$property_type.\"/\".$list_price.\"/\".($page+1) ?>\"><i class=\"material-icons\">chevron_right</i></a></li>\r\n            <?php } ?>   \r\n        </ul>\r\n\r\n        <hr>\r\n\r\n        <?php \r\n            //var_dump($listings);\r\n            $count = 0;\r\n            foreach($listings as $listing){ \r\n                $count++;\r\n                if ($count < sizeof($listings)){\r\n                    //setlocale(LC_MONETARY, \'en_US.utf8\');\r\n                    if($language == \'es\'){\r\n                        $price = \"$\" . number_format($listing[\"StandardFields\"][\"ListPrice\"] * $exchange_rate,2) . \" MXN\";\r\n                    }\r\n                    else{\r\n                        $price = \"$\" . number_format($listing[\"StandardFields\"][\"ListPrice\"],2) . \" USD\";\r\n                    }\r\n\r\n                    if (sizeof($listing[\"StandardFields\"][\"Photos\"]) > 0) {\r\n                        $thumb = $listing[\"StandardFields\"][\"Photos\"][0][\"Uri800\"];\r\n                    } else {\r\n                        $thumb = \'http://www.placehold.it/800x250?text=NO+PHOTO\';\r\n                    }\r\n\r\n                    $stai = $listing[\"StandardFields\"][\"StreetAdditionalInfo\"];\r\n					$stnu = $listing[\"StandardFields\"][\"StreetNumber\"];\r\n                    $stna = $listing[\"StandardFields\"][\"StreetName\"];\r\n                    //echo $stai . $stnu . $stna;\r\n                    $street = $stai != \'********\' ? $stai . \' \' : \'\';\r\n                    $street .= $stnu != \'********\' ? $stnu . \' \' : \'\';\r\n                    $street .= $stna != \'********\' ? $stna . \' \' : \'\';\r\n\r\n                    if (($count+2)%3 == 0) { ?> <div class=\"row mt-5 wow\"> <?php } ?>\r\n\r\n            <div class=\"col m4 s12 wow fadeIn\" data-wow-delay=\"0.2s\">\r\n            \r\n                <div class=\"card hoverable sticky-action\">\r\n                    <div class=\"card-image\">\r\n                        <div class=\"view overlay hm-white-slight activator\" style=\"height:250px; background-repeat: no-repeat; background-size: cover; background-position: center;background-image:url(\'<?php echo $thumb ?>\');\"></div>\r\n                        <!--a href=\"<?php echo $base_url.\"/listing/detail/\".$listing[\"StandardFields\"][\"ListingId\"] ?>\" class=\"btn-floating halfway-fab waves-effect waves-light indigo\"><i class=\"material-icons\">add</i></a-->\r\n                    </div>\r\n                    <div class=\"card-content\">\r\n                        <!--Title-->\r\n                        <h4 class=\"card-title activator right-align\"><?php echo $price ?><i class=\"material-icons right\">more_vert</i></h4>\r\n                        \r\n                        <!--Text-->\r\n                        <div class=\"card-text\">\r\n                            <p class=\"truncate\"><?php echo $street ?></p>\r\n                            <p><?php echo $listing[\"StandardFields\"][\"City\"] ?></p>\r\n                            <!--p>MLS Number: <?php echo $listing[\"StandardFields\"][\"ListingId\"] ?></p-->\r\n                        </div>\r\n                        <!--a href=\"#\" class=\"btn btn-primary\">Button</a-->\r\n                    </div>\r\n                    <div class=\"card-action\">\r\n                        <a href=\"<?php echo $base_url.\"/listing/detail/\".$listing[\"StandardFields\"][\"ListingId\"] ?>\" class=\"btn halfway-fab waves-effect waves-light indigo right\"><i class=\"material-icons\">add</i></a>\r\n                        <p><?php echo $listing[\"StandardFields\"][\"ListingId\"]?></p>\r\n                    </div>\r\n                    <div class=\"card-reveal activator\">\r\n                        <span class=\"card-title grey-text text-darken-4\"><i class=\"material-icons right activator\">close</i><?php echo $street ?></span>\r\n                        <p><?php echo $listing[\"StandardFields\"][\"City\"] ?></p>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n                    \r\n            <?php if (($count)%3 == 0 || $count == sizeof($listings) -1) { ?> </div> <?php } } }?>\r\n            \r\n\r\n        <hr>\r\n\r\n        <ul class=\"pagination center-align\">\r\n            <?php if ($page > 1) { ?>\r\n                <li class=\"waves-effect\"><a href=\"<?php echo $base_url.\"/listing\".\"/\".$city.\"/\".$property_type.\"/\".$list_price.\"/\".($page-1) ?>\"><i class=\"material-icons\">chevron_left</i></a></li>\r\n            <?php } ?>\r\n                \r\n            <?php \r\n                $total_pages = $listings[sizeof($listings)-1][\"TotalPages\"];\r\n                for($x = $page - 3; $x <= $page + 3; $x++) { \r\n                    if ($x > 0 && $x <= $total_pages) {?>\r\n                        <li class=\"waves-effect <?php echo $x == $page ? \'active indigo\' : \'\' ?>\"><a href=\"<?php echo $base_url.\"/listing\".\"/\".$city.\"/\".$property_type.\"/\".$list_price.\"/\".$x ?>\"><?php echo $x ?></a></li>\r\n                <?php } }\r\n            ?>\r\n\r\n            <?php if ($page < $total_pages) { ?>\r\n                <li class=\"waves-effect\"><a href=\"<?php echo $base_url.\"/listing\".\"/\".$city.\"/\".$property_type.\"/\".$list_price.\"/\".($page+1) ?>\"><i class=\"material-icons\">chevron_right</i></a></li>\r\n            <?php } ?>   \r\n        </ul>\r\n        \r\n    </div>\r\n</main>\r\n\r\n{layout:set name=\"scripts\"}\r\n    <!--script src=\"{theme_folder_url}site/default/asset/js/mls.js\" ></script>\r\n    <script>\r\n        var portal = <?php echo $portal; ?>;\r\n        var language = \'<?php echo $language; ?>\';\r\n        var exchange_rate = <?php echo $exchange_rate; ?>;\r\n        var selectedListing = \'\';\r\n        \r\n        function autoLoad(){\r\n            $(\'#mls_number\').val(\'<?php echo $mls_number; ?>\');\r\n            $(\'#city\').val(\'<?php echo $city; ?>\');\r\n            $(\'#property_type\').val(\'<?php echo $property_type; ?>\');\r\n            $(\'#list_price\').val(\'<?php echo $list_price; ?>\');\r\n            $(\'#development\').val(\'<?php echo $development; ?>\');\r\n            $(\'#submit\').click();\r\n        }\r\n        \r\n        $(function(){\r\n            $(\'#property_type\').change(function(){\r\n                if ($(this).val() != \'E\') {\r\n                    $(\"#list_price option[value=\'Le 200000.0\']\").remove();\r\n                } else if ($(\"#list_price option[value=\'Le 200000.0\']\").length == 0) {\r\n                    $(\'#list_price option:first\').after(\'<option value=\"Le 200000.0\"><?php echo $lang[$language][\'under\']; ?> 200,000 USD</option>\');\r\n                }\r\n            });\r\n        });\r\n    </script-->\r\n    <script>\r\n        //$(\'select\').formSelect();\r\n\r\n        $(\"#searchBtn\").click(function(){\r\n            var redirect = \"/listing\";\r\n            if ($.trim($(\"#mls_number\").val()) != \"\"){\r\n                redirect += \"/detail/\" + $(\"#mls_number\").val();\r\n            } else {\r\n                redirect += \"/\"+$(\"#city\").val();\r\n                redirect += \"/\"+$(\"#property_type\").val();\r\n                redirect += \"/\"+$(\"#list_price\").val();\r\n            }\r\n            console.log(redirect);\r\n            $(this).addClass(\'disabled\');\r\n            window.location.href = redirect;\r\n        });\r\n\r\n    </script>\r\n{/layout:set}', NULL, 1537558880, 1, 'n', 0, '', 'n', 'y', 'o', 0, 'n'),
(29, 1, 12, 'index', 'webpage', '{layout=\'layouts/_main-layout\'}', NULL, 1537557690, 1, 'n', 0, '', 'n', 'n', 'o', 0, 'n'),
(30, 1, 11, 'detail', 'webpage', '{layout=\'layouts/_main-layout\'}\r\n\r\n<?php\r\n    error_reporting( E_ALL ); //debug\r\n    //require_once($_SERVER[\'DOCUMENT_ROOT\'] . \"/flexmls/Core.php\");\r\n    require_once($_SERVER[\'DOCUMENT_ROOT\'] . \"/flexmls/flexmlsAPI.php\");\r\n    require_once($_SERVER[\'DOCUMENT_ROOT\'] . \"/lang/lang.php\");\r\n    $language = isset($_GET[\'lang\']) ? trim($_GET[\'lang\']) : \'en\';\r\n    $protocol = strtolower(substr($_SERVER[\"SERVER_PROTOCOL\"],0,5))==\'https://\'?\'https://\':\'http://\';\r\n    $hostName = $_SERVER[\'HTTP_HOST\'];\r\n    $base_url = $protocol.$hostName;\r\n    $search_results = \"\";\r\n    //var_dump($_SERVER);\r\n    if (isset($_SERVER[\'HTTP_REFERER\']) && strpos($_SERVER[\'HTTP_REFERER\'], $base_url.\'/listing\') > -1 ) { $search_results =  $_SERVER[\'HTTP_REFERER\']; }\r\n    //$api = new SparkAPI_APIAuth(\"cab_westerlund_key_1\", \"5lCZrVg8d4uYSviaNIN4t\"); //Core.php\r\n    $api = new flexmlsAPI(\"cab_westerlund_key_1\", \"5lCZrVg8d4uYSviaNIN4t\"); //flexmlsAPI.php\r\n    $api->SetApplicationName(\"Diamante-MLS-Search/1.0\");\r\n    $api->SetDeveloperMode(false);\r\n    $auth = $api->Authenticate();\r\n    if ($auth === false) api_error_thrown($api);\r\n\r\n    $id = \"{segment_3}\";\r\n    //echo $id;\r\n    $parameters = array(\"_expand\" => \'CustomFields,Photos\');\r\n    $listing = $api->GetListings(array(\"_filter\" => \"ListingId Eq \'\" . $id . \"\'\" , \"_expand\" => \'CustomFields,Photos\', \"_limit\" => \"1\", \"_pagination\" => true));\r\n    //$listing = $api->GetListing($id,$parameters);\r\n\r\n    //var_dump($listing);\r\n    if ($listing != null){\r\n        $standard = $listing[0][\'StandardFields\'];\r\n        $custom = $listing[0][\'CustomFields\'][0];\r\n\r\n        $main_photo = \'\';\r\n        $main_photo_name = \'\';\r\n        $photos = $standard[\'Photos\'];\r\n\r\n        foreach ($photos as $item) {\r\n            if ($item[\'Primary\'] == 1) {\r\n                $main_photo = $item[\'Uri1600\'];\r\n                $main_photo_name = $item[\'Name\'];\r\n            }\r\n        }\r\n\r\n        $general_desc = null;\r\n\r\n        $main = null;\r\n        $details = null;\r\n\r\n        $stai = $standard[\"StreetAdditionalInfo\"];\r\n        $stnu = $standard[\"StreetNumber\"];\r\n        $stna = $standard[\"StreetName\"];\r\n        //echo $stai . $stnu . $stna;\r\n        $street = $stai != \'********\' ? $stai . \' \' : \'\';\r\n        $street .= $stnu != \'********\' ? $stnu . \' \' : \'\';\r\n        $street .= $stna != \'********\' ? $stna . \' \' : \'\';\r\n\r\n        $exchange_rate = 1;\r\n\r\n        if($language == \'es\') {\r\n            $xml = simplexml_load_file(\"http://www.ecb.int/stats/eurofxref/eurofxref-daily.xml\")->Cube[0]->Cube[0];\r\n            $usd = 0;\r\n            $mxn = 0;\r\n            foreach ($xml->Cube as $item) {\r\n                if((string)$item[\'currency\'] === \'USD\')\r\n                    $usd = (real)$item[\'rate\'];\r\n                    \r\n                if((string)$item[\'currency\'] === \'MXN\')\r\n                    $mxn = (real)$item[\'rate\'];\r\n            }\r\n    \r\n            $exchange_rate = $mxn/$usd;\r\n        }\r\n\r\n        if($language == \'es\'){\r\n            $price = \"$\" . number_format($standard[\"ListPrice\"] * $exchange_rate,2) . \" MXN\";\r\n        }\r\n        else{\r\n            $price = \"$\" . number_format($standard[\"ListPrice\"],2) . \" USD\";\r\n        }\r\n\r\n        $description = \'\';\r\n\r\n        if($language == \'es\'){\r\n            error_reporting(0);\r\n            $json = file_get_contents(\'https://www.googleapis.com/language/translate/v2?key=AIzaSyA2XBI0Wlol8wIHwZ28nGvtpk01VBgdDAQ&q=\' . urlencode($standard[\'PublicRemarks\']) . \'&source=en&target=es\');\r\n            $json = json_decode($json, true);\r\n            $translations = $json[\'data\'][\'translations\'];\r\n            \r\n            foreach($translations as $translation) {\r\n                $description .= \"{$translation[\'translatedText\']}\";\r\n            }\r\n            \r\n            if(trim($description) == \'\')\r\n                $description = preg_replace(\'/[^a-zA-Z0-9\\s\\.,()-]/\',\'\', $standard[\'PublicRemarks\']);\r\n\r\n            echo \'<em style=\"font-size:10px;\">&bull; Los precios en pesos son calculados en base al tipo de cambio al momento de la consulta; el precio puede variar.<br />&bull; La información mostrada se tradujo de forma automatizada por lo tanto puede ser imprecisa.</em><br /><br />\';\r\n        }\r\n        else{\r\n            $description = preg_replace(\'/[^a-zA-Z0-9\\s\\.,()-]/\',\'\', $standard[\'PublicRemarks\']);\r\n        }\r\n\r\n        $map_lat = (str_replace(\"*\", \"\", number_format($standard[\'Latitude\'],6,\'.\',\'\')) == \"\") ? 24.161754 : $standard[\'Latitude\'];\r\n        $map_lon = (str_replace(\"*\", \"\", number_format($standard[\'Longitude\'],6,\'.\',\'\')) == \"\") ? -110.318013 : $standard[\'Longitude\'];\r\n\r\n    } //if listing != null\r\n?>\r\n\r\n{layout:set name=\"styles\"}\r\n    <style>\r\n        .hero{\r\n            height:400px;\r\n            width:100%;\r\n            background: url(\'<?=$main_photo?>\');\r\n            background-position: center;\r\n            background-size: cover;\r\n        }\r\n\r\n        #map_container {\r\n            width:100%;\r\n            height:500px;\r\n        }\r\n    </style>\r\n{/layout:set}\r\n\r\n\r\n<?php if($listing == null) { ?>\r\n    <main>\r\n        <div class=\"container\">\r\n            <h4 class=\"center\">Sorry, property not found</h4>\r\n\r\n            <p class=\"center\">\r\n                <?php if ($search_results != \"\") {?>\r\n                    <a href=\"<?=$search_results?>\" class=\"waves-effect waves-light btn\"><i class=\"material-icons left\">chevron_left</i> Back to search results  </a>\r\n                <?php } else { ?>\r\n                    <a href=\"/listing\" class=\"waves-effect waves-light btn\"><i class=\"material-icons left\">chevron_left</i> Back to listing </a>\r\n                <?php } ?>\r\n            </p>\r\n        </div>\r\n    </main>\r\n\r\n<?php } else { ?> \r\n\r\n    <div class=\"hero\">\r\n\r\n    </div>\r\n\r\n    <main>\r\n\r\n        <div class=\"container\">\r\n            <div class=\"row\">\r\n                <div class=\"col s12 m10\">\r\n\r\n                    <div id=\"description\" class=\"section scrollspy\">\r\n                        <h4><?= $id ?> / <?= $street ?></h4>\r\n                        <h5><?= $price ?></h5>  \r\n\r\n                        <p class=\"flow-text\"><?= $description ?> </p>\r\n                    </div>\r\n\r\n                    <div id=\"features\" class=\"section scrollspy\">\r\n                        <h5>Features</h5>\r\n                    </div>\r\n\r\n                    <div id=\"gallery\" class=\"section scrollspy\">\r\n                        <h5>Gallery</h5>\r\n\r\n                        <div class=\"carousel carousel-slider\">\r\n                            \r\n                                <?php foreach ($standard[\'Photos\'] as $photo) { ?>\r\n                                    <a class=\"carousel-item\" href=\"#<?=$photo[\'Id\']?>\">\r\n                                        <img src=\"<?=$photo[\'Uri800\']?>\">\r\n                                    </a>\r\n                                <?php } ?>\r\n                            \r\n                        </div>\r\n                    </div>\r\n\r\n                    <div id=\"map\" class=\"section scrollspy\">\r\n                        <h5>Map</h5>\r\n                        <div id=\"map_container\"></div>\r\n                    </div>\r\n\r\n                    \r\n                </div>\r\n                <div class=\"col hide-on-small-only m2\">\r\n                    <div class=\"pushpin\">            \r\n                        <h6>\r\n                            <?php if ($search_results != \"\") {?>\r\n                                <a href=\"<?=$search_results?>\"><i class=\"material-icons left\">chevron_left</i> Back to search results  </a>\r\n                            <?php } else { ?>\r\n                                <a href=\"/listing\"><i class=\"material-icons left\">chevron_left</i> Back to listing </a>\r\n                            <?php } ?>\r\n                        </h6>\r\n                        <ul class=\"section table-of-contents\">\r\n                            <li><a href=\"#description\">Description</a></li>\r\n                            <li><a href=\"#features\">Features</a></li>\r\n                            <li><a href=\"#gallery\">Gallery</a></li>\r\n                            <li><a href=\"#map\">Map</a></li>\r\n                        </ul>\r\n                    </div>\r\n                    <?php //var_dump($listing) ?>\r\n                </div>\r\n            </div>\r\n        </div>\r\n\r\n    </main>\r\n<?php } ?>\r\n\r\n\r\n{layout:set name=\"scripts\"}\r\n    <script src=\"https://maps.googleapis.com/maps/api/js?key=AIzaSyAnEhkVDYEAhWmyleuk7rvrVD6XcJ72q5A&callback=loadMap\" async defer></script>\r\n    <script>\r\n        function loadMap(){\r\n            var latlng = new google.maps.LatLng(<?php echo $map_lat . \',\' . $map_lon; ?>);\r\n            var opt = {\r\n                zoom: 15,\r\n                center: latlng,\r\n                mapTypeId: google.maps.MapTypeId.HYBRID\r\n            }\r\n            var map = new google.maps.Map(document.getElementById(\"map_container\"), opt);\r\n\r\n            var info = \'<p class=\"map_info\"><div class=\"thumb\"><img src=\"<?php echo $photos[0][\'UriThumb\']; ?>\" /></div>\'+\r\n                \'<b> <?php echo $price; ?></b><br />\'+\r\n                \'<?php echo $street; ?><br /><?php echo $standard[\'City\']; ?><br />\'+\r\n                \'<i class=\"\"><?php echo $standard[\'ListingId\']; ?></i></p>\';\r\n\r\n            var infowindow = new google.maps.InfoWindow({\r\n                content: info\r\n            });\r\n\r\n            var marker = new google.maps.Marker({\r\n                position: latlng,\r\n                animation: google.maps.Animation.DROP,\r\n                map: map,\r\n                title:\"<?php echo $street; ?>\"\r\n            });\r\n            \r\n            infowindow.open(map,marker);\r\n            \r\n            google.maps.event.addListener(marker, \'click\', function() {\r\n                infowindow.open(map,marker);\r\n            });\r\n        }\r\n\r\n        $( document ).ready(function(){\r\n            //$(\'.slider\').slider();\r\n            $(\'.carousel.carousel-slider\').carousel({\r\n                fullWidth: true,\r\n                indicators: true\r\n            });\r\n            $(\'.scrollspy\').scrollSpy();\r\n            $(\'.pushpin\').pushpin();\r\n            /*$(\'#fullscreen-btn\').click(function(){\r\n                var elem = document.querySelector(\'.slider\');\r\n                var instance = M.Slider.getInstance(elem);\r\n                instance.destroy(); \r\n                //$(\'.slider\').slider(\'destroy\');\r\n                $(\'.slider\').addClass(\'fullscreen\');\r\n                $(\'.slider\').slider();\r\n            });*/\r\n        });\r\n        \r\n    </script>\r\n{/layout:set}', NULL, 1537557691, 1, 'n', 0, '', 'n', 'n', 'o', 0, 'n'),
...
--
-- Truncate table before insert `exp_template_groups`
--
...
--
-- Truncate table before insert `exp_template_member_groups`
--

TRUNCATE TABLE `exp_template_member_groups`;
--
...
--
-- Truncate table before insert `exp_template_no_access`
--

TRUNCATE TABLE `exp_template_no_access`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_template_routes`
--

TRUNCATE TABLE `exp_template_routes`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_throttle`
--

TRUNCATE TABLE `exp_throttle`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_update_log`
--

TRUNCATE TABLE `exp_update_log`;
--
...
--
-- Truncate table before insert `exp_update_notices`
--

TRUNCATE TABLE `exp_update_notices`;
--
...
--
-- Truncate table before insert `exp_upload_no_access`
--

TRUNCATE TABLE `exp_upload_no_access`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `exp_upload_prefs`
--

TRUNCATE TABLE `exp_upload_prefs`;
--
...
--
ALTER TABLE `exp_channel_form_settings`
  MODIFY `channel_form_settings_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `exp_channel_titles`
  MODIFY `entry_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `exp_security_hashes`
  MODIFY `hash_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
...
--
ALTER TABLE `exp_templates`
  MODIFY `template_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `exp_template_groups`
--
ALTER TABLE `exp_template_groups`
  MODIFY `group_id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
